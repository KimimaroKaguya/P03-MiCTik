<?php
    ...
    if(!empty($_GET['did'])){
        mysqli_query("DELETE FROM mt_config WHERE mt_id='".$_GET['did']."' AND mt_owner = '".$_SESSION['EmpUser']."'");
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        echo "<tr>";
                                          ...
                                          echo "<td><center>".$result['mt_name']."</center></td>";                           
                                          echo "<td><center>".$result['mt_location']."</center></td>";
                                          echo "<td><center>".$ARRAY['0']['cpu-load']."%</center></td>";                                                                                       
                                          echo "<td><center>".round($ram,1)." MB</center></td>";
                                          echo "<td><center>".round($hdd,1)." MB</center></td>";
                                          echo "<td><center>";
                                            if($API->connect($result['mt_ip'], $result['mt_user'], $result['mt_pass'])){
                                              echo "<center><button type=\"button\" class=\"btn btn-success\"><i class=\"fa fa-check\"></i> CONNECT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></center>";
                                              $conn="connect";  
                                            }else{
                                              echo "<center><button type=\"button\" class=\"btn btn-danger\"><i class=\"fa fa-times\"></i> DISCONNECT</button></center>";
                                              $conn="disconnect";
                                            }                                 
                                          echo "</td>"; 
                                                                    
                                          echo "<td><a href='site/site_conn.php?id=".$result['mt_id']."&conn=".$conn."'><center><button type=\"button\" class=\"btn btn-success\" title=\"เข้าบริหารจัดการ\"><i class=\"fa fa-paper-plane-o\"></i></button></center></a>";                        
                                        echo "</td>";
                                        echo "</tr>";
                                        }
                                      ?>
