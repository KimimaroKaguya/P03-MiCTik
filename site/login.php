...
<html lang="en">
    ...
    <head>
        ...
        <title>โปรแกรมบริหารจัดการอินเตอร์เน็ตห้องสมุด</title>
        ...
        <link rel="shortcut icon" href="assets/ico/nongbua.png">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>โปรแกรมบริหารจัดการอินเตอร์เน็ต</strong> ห้องสมุด</h1>
                            <div class="description">
                            	<p>
	                            	NONGBUA SCHOOL  Desing By Student    
                            	</p>
                            </div>
                        </div>
                    </div>
