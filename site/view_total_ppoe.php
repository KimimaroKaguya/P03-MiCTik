    ...
    if($_REQUEST['check']!=""){ 
      echo"<body onload=\"window.print();\"> ";
        for($i=0;$i < count($_REQUEST['check']);$i++){
          ...
          //$sql = mysql_query("SELECT * FROM mt_gen_pppoe WHERE user='".$_GET['id']."'");
...
//เปิดส่วน  คำสั่ง นับจำนวนนักเรียน ทั้งหมดที่มีอยู่ในตาราง
      $sql = "SELECT * FROM  mt_gen_pppoe WHERE  profile  LIKE  '%teacher%'  "; // เลือกข้อมูลจากตาราง tb_data_std  นำค่ามาเก็บไว้ที่ ตัวแปรชื่อว่า  $sql
...
//เปิดส่วน  คำสั่ง นับจำนวนนักเรียนชาย ทั้งหมดที่มีอยู่ในตาราง
     $sql = "SELECT * FROM  mt_gen_pppoe WHERE  profile  LIKE  '%studen%'  ";
     $query = mysqli_query($conn, $sql);
     $student_sum_score = mysqli_num_rows($query);                    
//เปิดส่วน  คำสั่ง นับจำนวนนักเรียนชาย ทั้งหมดที่มีอยู่ในตาราง       
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//เปิดส่วน  คำสั่ง นับนักเรียนชาย ทั้งหมดที่มีอยู่ในตาราง
      $sql = "SELECT * FROM  mt_gen_pppoe WHERE  profile  LIKE  '%guest%'  ";             // เลือกข้อมูลจากตาราง tb_data_std  นำค่ามาเก็บไว้ที่ ตัวแปรชื่อว่า  $sql
      $query = mysqli_query($conn,$sql);                              // การเชื่อมข้อมูลจากตารางที่เลือก เข้ากับฐานข้อมูล  แล้วนำค่ามาเก็บไว้ที่ $query
...
//ปิดส่วน  คำสั่ง นับนักเรียนชาย ทั้งหมดที่มีอยู่ในตาราง
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     $sql = "SELECT * FROM  mt_gen_pppoe WHERE  profile  LIKE  '%bit%'  ";    // เลือกข้อมูล  จากฟิลว์ที่เราต้องการ โดยจะรวมข้อมูลที่ซ้ำกัน                                                                       
...
<LINK REL="SHORTCUT ICON" HREF="../dist/img/f5.ico">       <!--+++++++  คำสั่งเรียกใช้ ภาพ ของ icon แสดงบน title bar ++++++++-->
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ค้นหาข้อมูลผู้ใช้งานอินเตอร์เน็ต รอหน่อยนะค่ะเอาใว้ปรับปรุงใน version ต่อไปค่ะ
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">PPPOE USER</h3>
                          </div>
                                        <center>
